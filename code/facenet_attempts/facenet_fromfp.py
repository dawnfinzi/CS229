...
def main():
	...
	bs_placeholder = tf.placeholder(tf.int32)
	saver = tf.train.import_meta_graph(META_PATH, input_map={'batch_size': bs_placeholder})
	...
	layer = model_outputs["Conv2d_1a_3x3"]
	...
	for step in range(params['steps']):
		loss_list.append(sess.run(loss, feed_dict={bs_placeholder: 1}))
		break
